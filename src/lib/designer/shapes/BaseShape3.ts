...
//       return getShapeFromConfig({conf, parent: this as any})
//     }) ?? []
//   }
//
//
...
// }
//
// class ShapeSelect extends BaseShapeProps {
//   //移动图形
//   move(point: P) {
//     let cu = CanvasUtil2.getInstance()
//     let {x, y,} = point
...
// }
//
// class ShapeEdit extends ShapeSelect {
...
// }
//
// export abstract class BaseShape extends ShapeEdit {
